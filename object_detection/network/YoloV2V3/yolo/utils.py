...
def get_region_boxes(output: object, netshape: object, conf_thresh: object, num_classes: object, anchors: object,
                     num_anchors: object, only_objectness: object = 1,
                     validation: object = False,
                     device: object = 'cuda:0') -> object:
    ...
    output = output.view(batch * num_anchors, k, h * w).transpose(0, 1).contiguous().view(k, cls_anchor_dim)
